/**
 * Step templates for each scenario, keyed by scenario TITLE (matched after DB fetch).
 * These are used at simulation-start time to create SimulationStep rows.
 */
...
export const SCENARIO_STEP_TEMPLATES: Record<string, StepTemplate[]> = {
